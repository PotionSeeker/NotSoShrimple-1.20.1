...
public class EntityBloodWater extends AbstractHurtingProjectile implements GeoEntity {
    ...
    public EntityBloodWater(EntityType<? extends AbstractHurtingProjectile> p_37248_, Level p_37249_) {
